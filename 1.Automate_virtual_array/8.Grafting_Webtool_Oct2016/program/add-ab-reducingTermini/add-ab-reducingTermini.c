...
for( ri=0; ri < A.m[0][0].nr; ri++ ){
  //  printf("Checking %s-%d\n",A.m[0][0].r[ri].N,A.m[0][0].r[ri].n);
    if( A.m[0][0].r[ri].n == resNum ){
        ...
        if ( EndsWith( A.m[0][0].r[ri].N, "SA" ) ){
            strcpy (atomName, "O2");
            for( ai = 0; ai < A.m[0][0].r[ri].na; ai++ ){
                if( strcmp( A.m[0][0].r[ri].a[ai].N, "C4" ) == 0 ) { a = &A.m[0][0].r[ri].a[ai].x; /*printf( "a, " );*/ }
                if( strcmp( A.m[0][0].r[ri].a[ai].N, "C3" ) == 0 ) { b = &A.m[0][0].r[ri].a[ai].x; /*printf( "b, " );*/ }
