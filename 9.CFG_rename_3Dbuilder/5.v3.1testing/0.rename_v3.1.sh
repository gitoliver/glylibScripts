...
cat input.dat | sed 's/(/\[/g;
	...
	s/-3-/-3/g;
	s/-2-/-2/g;	
	s/\ //g;' | grep -v "9Ac" | grep -v "9NAc" | grep -v "Mur" | grep -v "Lys" | grep -v "KDN" | grep -v "ola" | grep -v "6P" | grep -v "\[Gc\]" | grep -v "H2PO3" | grep -v "NH2" | grep -v "NKT" | grep -v "CH3" | grep -v "G-ol" | grep -v "NAcb1-4\]6b1" | grep -v "4\]5" | grep -v "," | grep -v 374 > output0.txt
